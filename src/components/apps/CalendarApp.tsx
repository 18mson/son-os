      ...
      <div className={`px-4 py-3 border-b flex items-center justify-between gap-3 shrink-0 ${
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className={`text-[10px] ${isLight ? "text-slate-600" : "text-zinc-400"}`}>Kalender & Agenda Indonesia</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className={`flex items-center rounded-lg border p-0.5 ${
            ...
            <button onClick={prevMonth} className="p-1 rounded-md hover:bg-black/10 cursor-pointer">
              <ChevronLeft size={16} />
            </button>
            <button onClick={nextMonth} className="p-1 rounded-md hover:bg-black/10 cursor-pointer">
