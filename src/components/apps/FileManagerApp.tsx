    ...
    <div className={`flex flex-col h-full w-full select-none font-sans overflow-hidden ${
      ...
      <div className={`px-4 py-2.5 border-b flex flex-wrap items-center justify-between gap-3 shrink-0 ${
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <FolderPlus size={14} className="text-amber-400" /> Folder Baru
          </button>
          <button
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        ...
        {items.length === 0 && !isCreatingFolder ? (
          <div className="h-64 flex flex-col items-center justify-center text-center">
            ...
            <h3 className={`text-sm font-bold ${isLight ? "text-slate-900" : "text-white"}`}>Folder Kosong</h3>
            <p className={`text-xs mt-1 max-w-xs ${isLight ? "text-slate-500" : "text-zinc-400"}`}>
              Unggah file baru atau buat folder untuk mulai menyimpan dokumen di Son-OS.
            </p>
          </div>
        ) : (
          <FileItemGrid
