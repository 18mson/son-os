...
export const CameraControls: React.FC<CameraControlsProps> = ({
  ...
  return (
    <div className="px-6 py-4 bg-zinc-950/90 border-t border-white/10 flex items-center justify-between shrink-0 relative z-20 backdrop-blur-md">
      {/* Left Aux Controls */}
      ...
      <div className="flex items-center justify-center">
        <button
          ...
          title="Ambil Foto"
          className="relative w-16 h-16 rounded-full bg-white text-zinc-950 flex items-center justify-center shadow-2xl hover:scale-105 active:scale-95 transition-all cursor-pointer border-4 border-purple-500/60 disabled:opacity-50"
        >
          {isCapturing ? (
            <Loader2 className="animate-spin text-purple-600" size={26} />
          ) : (
            <div className="w-12 h-12 rounded-full bg-white border-2 border-zinc-950/20 flex items-center justify-center">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="p-2.5 rounded-full bg-white/10 hover:bg-white/20 text-zinc-300 transition-all cursor-pointer"
        >
          <RotateCw size={18} />
        </button>
