...
export const WALLPAPERS_LIST: WallpaperItem[] = [
  ...
  },
  {
    ...
    nameId: "Cakrawala Senja",
    category: "classic",
    descriptionEn: "Warm rose, amber, and purple twilight glow",
    descriptionId: "Kilau senja mawar hangat, amber, dan ungu lembut",
    bgClass: "bg-linear-to-br from-zinc-950 via-rose-950 to-amber-950",
    glowTopLeft: "bg-rose-500/40",
    glowBottomRight: "bg-amber-500/40",
    fractalType: "none",
    previewGradient: "bg-linear-to-tr from-amber-600 via-rose-700 to-purple-900",
    accentColor: "#f43f5e",
  },
  {
    id: "ocean",
    name: "Pacific Deep",
    nameEn: "Pacific Deep Ocean",
    nameId: "Samudra Pasifik Dalam",
    category: "classic",
    descriptionEn: "Calming cyan, sky blue, and deep sapphire ocean gradient",
    descriptionId: "Gradien samudra sian, biru langit, dan safir dalam",
    bgClass: "bg-linear-to-br from-slate-950 via-cyan-950 to-blue-950",
    glowTopLeft: "bg-cyan-500/40",
    glowBottomRight: "bg-blue-600/40",
    fractalType: "none",
    previewGradient: "bg-linear-to-b from-cyan-900 via-blue-950 to-slate-950",
    accentColor: "#06b6d4",
  },
  {
    id: "emerald",
    name: "Nordic Forest",
    nameEn: "Nordic Forest Emerald",
    nameId: "Hutan Nordik Zamrud",
    category: "classic",
    descriptionEn: "Serene deep emerald green and dark spruce gradient",
    descriptionId: "Gradien hijau zamrud teduh dan cemara gelap",
    bgClass: "bg-linear-to-br from-slate-950 via-emerald-950 to-teal-950",
    glowTopLeft: "bg-emerald-500/40",
  ...
  },
  {
    ...
    nameId: "Neon Siberpunk",
    category: "classic",
    descriptionEn: "Vibrant neon magenta and deep purple cyberpunk aesthetics",
    descriptionId: "Estetika siberpunk magenta neon dan ungu gelap cerah",
    ...
    fractalType: "none",
    previewGradient: "bg-linear-to-r from-fuchsia-900 via-purple-950 to-zinc-950",
    accentColor: "#d946ef",
  },
  {
    id: "abstract",
    name: "Monochrome Slate",
    nameEn: "Monochrome Slate Dark",
    nameId: "Monokrom Abu Gelap",
    category: "classic",
    descriptionEn: "Ultra-clean dark slate monochrome gradient for deep focus",
    descriptionId: "Gradien monokrom abu-abu gelap bersih untuk fokus maksimal",
    ...
    fractalType: "none",
    previewGradient: "bg-linear-to-tr from-slate-800 via-zinc-900 to-stone-950",
    accentColor: "#94a3b8",
  },
];
